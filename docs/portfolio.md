...
fun buildChatModel(provider: LlmProvider, apiKey: String): ChatModel {
...
@Bean
fun llmRateLimiter(@Value("\${app.async.virtual.llm-max-concurrency}") maxConcurrency: Int): Semaphore {
