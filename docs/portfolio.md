...
**Spring AI Ops**는 모니터링·형상관리 도구체인을 LLM과 연결하는 AI 기반 운영 자동화 도구입니다.  
Grafana Alerting, GitHub, GitLab의 webhook을 수신하여 오류 분석·코드 리뷰·정적 코드 위험 분석을 실시간으로 수행하고, 결과를 WebSocket 대시보드에 스트리밍합니다.  
